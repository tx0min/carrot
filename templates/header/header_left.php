...
?>
<div class="row">		
	<div class="col-sm-5 col-xs-6 col-xs-offset-3 col-sm-offset-0 text-left text-sm-center">
	...
	<div class="col-xs-7 text-right text-sm-center hidden-xs hidden-sm">
		<?php
...
<div class="row">
	<div class="col-xs-12 ">
		<div class="header-menu text-right hidden-xs hidden-sm">
			<?php
